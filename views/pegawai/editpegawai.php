                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <form action="model/pegawai/prosesupdatepegawai.php" method="POST">
                            <input type="hidden" name="id_anggota" id="id_pegawai" value="<?php echo $hasil['id_pegawai']?>">
                            <table class="table">
                                <tr>
                                    <td>Nama Pegawai</td>
                                    <td>:</td>
                                    <td><input type="text"  class="form-control" name="nama_pegawai" id="nama_pegawai" value="<?php echo $hasil['nama_anggota']?>"></td>
                                </tr>
                                <tr>
                                    <td>Jenis Kelamin</td>
                                    <td>:</td>
